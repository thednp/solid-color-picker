...
export const PickerContext = createContext({
  ...
  visuals: (() => []) as unknown as Accessor<HTMLCollectionOf<HTMLElement>>,
  knobs: (() => []) as unknown as Accessor<Array<HTMLElement>>,
  inputs: (() => []) as unknown as Accessor<HTMLCollectionOf<HTMLElement>>,
