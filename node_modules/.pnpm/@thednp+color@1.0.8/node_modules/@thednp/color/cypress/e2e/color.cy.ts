...
import roundPart from "../../src/util/roundPart";
...
describe("Color Class Tests", () => {
  ...
  it("Test Init - set specific format", () => {
    ...
    expect(new Color("hsl   0 100 50", "rgb").toString()).to.equal(
      "rgb(255, 0, 0)"
    );
    expect(new Color("hsl 120 100 50", "rgb").toString()).to.equal(
      "rgb(0, 255, 0)"
    );
    expect(new Color("hsl 240 100 50", "rgb").toString()).to.equal(
      "rgb(0, 0, 255)"
    );
    expect(new Color("hsl 300 100 50", "rgb").toString()).to.equal(
      "rgb(255, 0, 255)"
    );
    expect(new Color("hsl 180 100 50", "rgb").toString()).to.equal(
      "rgb(0, 255, 255)"
    );

    expect(new Color("hwb   0 0 0", "rgb").toString()).to.equal(
      "rgb(255, 0, 0)"
    );
    expect(new Color("hwb 120 0 0", "rgb").toString()).to.equal(
      "rgb(0, 255, 0)"
    );
    expect(new Color("hwb 240 0 0", "rgb").toString()).to.equal(
      "rgb(0, 0, 255)"
    );
    expect(new Color("hwb 300 0 0", "rgb").toString()).to.equal(
      "rgb(255, 0, 255)"
    );
    expect(new Color("hwb 180 0 0", "rgb").toString()).to.equal(
      "rgb(0, 255, 255)"
    );

    expect(new Color("hsv   0 100 100", "rgb").toString()).to.equal(
      "rgb(255, 0, 0)"
    );
    expect(new Color("hsv 120 100 100", "rgb").toString()).to.equal(
      "rgb(0, 255, 0)"
    );
    expect(new Color("hsv 240 100 100", "rgb").toString()).to.equal(
      "rgb(0, 0, 255)"
    );
    expect(new Color("hsv 300 100 100", "rgb").toString()).to.equal(
      "rgb(255, 0, 255)"
    );
    expect(new Color("hsv 180 100 100", "rgb").toString()).to.equal(
      "rgb(0, 255, 255)"
    );
    ...
    expect(new Color("rgb 255 0 0", "hwb").toString()).to.equal(
      "hwb(0deg 0% 0%)"
    );
    expect(new Color("rgb 0 255 0", "hwb").toString()).to.equal(
      "hwb(120deg 0% 0%)"
    );
    expect(new Color("rgb 0 0 255", "hwb").toString()).to.equal(
      "hwb(240deg 0% 0%)"
    );
    expect(new Color("rgb 255 0 255", "hwb").toString()).to.equal(
      "hwb(300deg 0% 0%)"
    );
    expect(new Color("rgb 0 255 255", "hwb").toString()).to.equal(
      "hwb(180deg 0% 0%)"
    );

    expect(new Color("hsl   0 100 50", "hwb").toString()).to.equal(
      "hwb(0deg 0% 0%)"
    );
    expect(new Color("hsl 120 100 50", "hwb").toString()).to.equal(
      "hwb(120deg 0% 0%)"
    );
    expect(new Color("hsl 240 100 50", "hwb").toString()).to.equal(
      "hwb(240deg 0% 0%)"
    );
    expect(new Color("hsl 300 100 50", "hwb").toString()).to.equal(
      "hwb(300deg 0% 0%)"
    );
    expect(new Color("hsl 180 100 50", "hwb").toString()).to.equal(
      "hwb(180deg 0% 0%)"
    );

    expect(new Color("hsv   0 100 100", "hwb").toString()).to.equal(
      "hwb(0deg 0% 0%)"
    );
    expect(new Color("hsv 120 100 100", "hwb").toString()).to.equal(
      "hwb(120deg 0% 0%)"
    );
    expect(new Color("hsv 240 100 100", "hwb").toString()).to.equal(
      "hwb(240deg 0% 0%)"
    );
    expect(new Color("hsv 300 100 100", "hwb").toString()).to.equal(
      "hwb(300deg 0% 0%)"
    );
    expect(new Color("hsv 180 100 100", "hwb").toString()).to.equal(
      "hwb(180deg 0% 0%)"
    );
    ...
    expect(new Color("rgb 255 0 0", "hsl").toString()).to.equal(
      "hsl(0, 100%, 50%)"
    );
    expect(new Color("rgb 0 255 0", "hsl").toString()).to.equal(
      "hsl(120, 100%, 50%)"
    );
    expect(new Color("rgb 0 0 255", "hsl").toString()).to.equal(
      "hsl(240, 100%, 50%)"
    );
    expect(new Color("rgb 255 0 255", "hsl").toString()).to.equal(
      "hsl(300, 100%, 50%)"
    );
    expect(new Color("rgb 0 255 255", "hsl").toString()).to.equal(
      "hsl(180, 100%, 50%)"
    );

    expect(new Color("hwb   0 0 0", "hsl").toString()).to.equal(
      "hsl(0, 100%, 50%)"
    );
    expect(new Color("hwb 120 0 0", "hsl").toString()).to.equal(
      "hsl(120, 100%, 50%)"
    );
    expect(new Color("hwb 240 0 0", "hsl").toString()).to.equal(
      "hsl(240, 100%, 50%)"
    );
    expect(new Color("hwb 300 0 0", "hsl").toString()).to.equal(
      "hsl(300, 100%, 50%)"
    );
    expect(new Color("hwb 180 0 0", "hsl").toString()).to.equal(
      "hsl(180, 100%, 50%)"
    );

    expect(new Color("hsv   0 100 100", "hsl").toString()).to.equal(
      "hsl(0, 100%, 50%)"
    );
    expect(new Color("hsv 120 100 100", "hsl").toString()).to.equal(
      "hsl(120, 100%, 50%)"
    );
    expect(new Color("hsv 240 100 100", "hsl").toString()).to.equal(
      "hsl(240, 100%, 50%)"
    );
    expect(new Color("hsv 300 100 100", "hsl").toString()).to.equal(
      "hsl(300, 100%, 50%)"
    );
    expect(new Color("hsv 180 100 100", "hsl").toString()).to.equal(
      "hsl(180, 100%, 50%)"
    );
  ...
  it("Color Object to RGB Object", () => {
    ...
    expect(new Color({ h: "0deg", w: 0, b: 0 }).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    ...
    expect(new Color({ h: "120", w: 0, b: 0 }).toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 1,
    ...
    expect(new Color({ h: "240", w: 0, b: 0 }).toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 1,
  ...
  it("Color Object to HSL Object", () => {
    // red
    expect(new Color({ r: "255", g: 0, b: 0 }).toHsl()).to.deep.equal({
      h: 0,
      s: 1,
      l: 0.5,
      a: 1,
    ...
    expect(new Color({ h: "0deg", w: 0, b: 0 }).toHsl()).to.deep.equal({
      h: 0,
      s: 1,
      l: 0.5,
      a: 1,
    ...
    // green
    expect(new Color({ r: 0, g: "255", b: 0 }).toHsl()).to.deep.equal({
      h: 12 / 36,
      s: 1,
      l: 0.5,
      a: 1,
    ...
    expect(new Color({ h: "120", w: 0, b: 0 }).toHsl()).to.deep.equal({
      h: 12 / 36,
      s: 1,
      l: 0.5,
      a: 1,
    ...
    // blue
    expect(new Color({ r: 0, g: 0, b: "255" }).toHsl()).to.deep.equal({
      h: 24 / 36,
      s: 1,
      l: 0.5,
      a: 1,
    ...
    expect(new Color({ h: "240", w: 0, b: 0 }).toHsl()).to.deep.equal({
      h: 24 / 36,
      s: 1,
      l: 0.5,
      a: 1,
  ...
  it("Color Object to HSV Object", () => {
    // red
    expect(new Color({ r: "255", g: 0, b: 0 }).toHsv()).to.deep.equal({
      h: 0,
      s: 1,
      v: 1,
      a: 1,
    ...
    expect(new Color({ h: "0deg", w: 0, b: 0 }).toHsv()).to.deep.equal({
      h: 0,
      s: 1,
      v: 1,
      a: 1,
    ...
    // green
    expect(new Color({ r: 0, g: "255", b: 0 }).toHsv()).to.deep.equal({
      h: 12 / 36,
      s: 1,
      v: 1,
      a: 1,
    ...
    expect(new Color({ h: "120", w: 0, b: 0 }).toHsv()).to.deep.equal({
      h: 12 / 36,
      s: 1,
      v: 1,
      a: 1,
    ...
    // blue
    expect(new Color({ r: 0, g: 0, b: "255" }).toHsv()).to.deep.equal({
      h: 24 / 36,
      s: 1,
      v: 1,
      a: 1,
    ...
    expect(new Color({ h: "240", w: 0, b: 0 }).toHsv()).to.deep.equal({
      h: 24 / 36,
      s: 1,
      v: 1,
      a: 1,
  ...
  it("Color Object to HWB Object", () => {
    // red
    expect(new Color({ r: "255", g: 0, b: 0 }).toHwb()).to.deep.equal({
      h: 0,
      w: 0,
      b: 0,
      a: 1,
    ...
    // green
    expect(new Color({ r: 0, g: "255", b: 0 }).toHwb()).to.deep.equal({
      h: 12 / 36,
      w: 0,
      b: 0,
      a: 1,
    ...
    // blue
    expect(new Color({ r: 0, g: 0, b: "255" }).toHwb()).to.deep.equal({
      h: 24 / 36,
      w: 0,
      b: 0,
      a: 1,
  ...
  it("RegExp test - CSS3/CSS4 abnormal value spacing", () => {
    expect(new Color(" rgb( 255, 0,  0,   0.5 ) ").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("hsl (120,  100,50,0.6 ) ").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.6,
    });
    expect(new Color("hsv ( 240,100,100,0.7 )").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.7,
    });
    expect(new Color("hwb ( 360 , 0, 0 , 0. 7 )").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0,
  ...
  it("RegExp test - CSS3 valid RGB value", () => {
    expect(new Color("rgba(255,0,0,0.5)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("rgba(0,255,0,0.6)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.6,
    });
    expect(new Color("rgba(0,0,255,0.7)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.7,
  ...
  it("RegExp test - CSS3/CSS4 permissive RGB value", () => {
    expect(new Color("rgb 255 0 0 50").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("rgb 0 255 0 70").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.7,
    });
    expect(new Color("rgb 0 0 255 25").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.25,
  ...
  it("RegExp test - CSS3 valid percentage RGB value", () => {
    expect(new Color("rgba(100%, 0%, 0%, 0.5)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("rgba(0%, 100%, 0%, 0.1)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.1,
    });
    expect(new Color("rgba(0%, 0%, 100%, 0.3)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.3,
    });
    expect(new Color("rgba(100%, 0%, 0%, 50%)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("rgba(0%, 100%, 0%, 50%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.5,
    });
    expect(new Color("rgba(0%, 0%, 100%, 30%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.3,
  ...
  it("RegExp test - CSS4 valid RGB value", () => {
    expect(new Color("rgb(255 0 0)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(new Color("rgb(0 255 0)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 1,
    });
    expect(new Color("rgb(0 0 255)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 1,
    ...
    expect(new Color("rgb(0 255 0 / 25%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.25,
    });
    expect(new Color("rgb(0 0 255 / 90%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.9,
  ...
  it("RegExp test - CSS3 valid HSL value", () => {
    expect(new Color("hsl(0,100,50,0.3)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.3,
    });
    expect(new Color("hsl(120,100,50,0.7)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.7,
    });
    expect(new Color("hsl(240,100,50,0.5)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.5,
  ...
  it("RegExp test - CSS3/CSS4 permissive HSL value", () => {
    expect(new Color("hsl 0 100 50 60").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.6,
    });
    expect(new Color("hsl 120 100 50 25").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.25,
    });
    expect(new Color("hsl 240 100 50 35").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.35,
  ...
  it("RegExp test - CSS4 valid HSL value", () => {
    expect(new Color("hsl(0deg 100% 50%)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(new Color("hsl(120deg 100% 50%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 1,
    });
    expect(new Color("hsl(240deg 100% 50%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 1,
  ...
  it("RegExp test - CSS4 valid HSL value with alpha", () => {
    expect(new Color("hsl(0deg 100% 50% / 40%)").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.4,
    });
    expect(new Color("hsl(120deg 100% 50% / 30%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.3,
    });
    expect(new Color("hsl(240deg 100% 50% / 80%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.8,
  ...
  it("RegExp test - CSS3 valid HSV value", () => {
    expect(new Color("hsv(0,100,50)").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(new Color("hsv(120,100,50)").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 1,
    });
    expect(new Color("hsv(240,100,50)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 1,
    });
    expect(new Color("hsv(0,100,50,0.3)").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 0.3,
    });
    expect(new Color("hsv(120,100,50,0.4)").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 0.4,
    });
    expect(new Color("hsv(240,100,50,0.4)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 0.4,
  ...
  it("RegExp test - CSS3/CSS4 permissive HSV value", () => {
    expect(new Color("hsv 0 100 50 60").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 0.6,
    });
    expect(new Color("hsv 120 100 50 70").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 0.7,
    });
    expect(new Color("hsv 240 100 50 20").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 0.2,
  ...
  it("RegExp test - CSS4 valid HSV value", () => {
    expect(new Color("hsv(0deg 100% 50% / 40%)").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 0.4,
    });
    expect(new Color("hsv(120deg 100% 50% / 20%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 0.2,
    });
    expect(new Color("hsv(240deg 100% 50% / 10%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 0.1,
  ...
  it("RegExp test - CSS4 valid HWB values", () => {
    expect(new Color("hwb(0deg 0% 50%)").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(new Color("hwb(120deg 0% 50%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 1,
    });
    expect(new Color("hwb(240deg 0% 50%)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 1,
    });
    expect(new Color("hwb(0deg 0% 50% / 40%)").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 0.4,
    });
    expect(new Color("hwb(120deg 0% 50% / 60%)").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 0.6,
    });
    expect(new Color("hwb(240deg 0% 50% / 0.35)").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 0.35,
  ...
  it("RegExp test - CSS4 permissive HWB value with alpha", () => {
    expect(new Color("hwb 0 0 50 40").toRgb()).to.deep.equal({
      r: 255 / 2,
      g: 0,
      b: 0,
      a: 0.4,
    });
    expect(new Color("hwb 120 0 50 10").toRgb()).to.deep.equal({
      r: 0,
      g: 255 / 2,
      b: 0,
      a: 0.1,
    });
    expect(new Color("hwb 240 0 50 03").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255 / 2,
      a: 0.03,
  ...
  it("RegExp test - CSS3 valid HEX value", () => {
    expect(new Color("#ff0000").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(new Color("#00ff00").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 1,
    });
    expect(new Color("#0000ff").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 1,
    });
    expect(new Color("#ff000080").toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
    });
    expect(new Color("#00ff0080").toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 0.5,
    });
    expect(new Color("#0000ff80").toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 0.5,
  ...
  it("Testing Web Colors", () => {
    cy.log(
      "a small collection of hand picked web safe colors from https://en.wikipedia.org/wiki/Web_colors"
    )
      .wrap(sampleWebcolors)
      .as("webColors")
      .get("@webColors")
      .each((c: Record<string, any>) => {
        ...
        expect(
          [h, s, v].map((x) => Math.round(x * 10 ** 3) / 10 ** 3)
        ).to.deep.equal([c.hsv.h, c.hsv.s, c.hsv.v]);
      });
  });
  ...
  it("Test grey tints with all formats", () => {
    ...
    expect(
      [h1, s1, v1].map((x) => Math.round(x * 10 ** 6) / 10 ** 6)
    ).to.deep.equal([0, 0, 0.733333]);
  ...
  it("Test Color Getters", () => {
    ...
    expect(roundPart(color.brightness)).to.equal(76);
  ...
  it("Test Color Export `toString` all supported formats", () => {
    ...
    expect(color.clone().spin(240).setAlpha(0.8).toHex8String(true)).to.equal(
      "#00fc"
    );
  });
  ...
  it("Test Color Manipulation - spin", () => {
    expect(color.clone().spin().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(color.clone().spin(0).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(color.clone().spin(120).toRgb()).to.deep.equal({
      r: 0,
      g: 255,
      b: 0,
      a: 1,
    });
    expect(color.clone().spin(240).toRgb()).to.deep.equal({
      r: 0,
      g: 0,
      b: 255,
      a: 1,
    });
    expect(color.clone().spin(360).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
  ...
  it("Test Color Manipulation - setAlpha", () => {
    expect(color.clone().setAlpha().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(color.clone().setAlpha(0).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0,
    });
    expect(color.clone().setAlpha(1).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    });
    expect(color.clone().setAlpha(0.5).toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 0.5,
  ...
  it("Test Color Manipulation - lighten", () => {
    expect(color.clone().lighten().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    ...
    expect([r, g, b].map(roundPart)).to.deep.equal([255, 51, 51]);
  });
  it("Test Color Manipulation - darken", () => {
    expect(color.clone().darken().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    ...
    expect([r, g, b].map(roundPart)).to.deep.equal([204, 0, 0]);
  });
  it("Test Color Manipulation - saturate", () => {
    expect(color.clone().saturate().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    ...
    expect([r, g, b].map(roundPart)).to.deep.equal([41, 61, 41]);
  });
  it("Test Color Manipulation - desaturate", () => {
    expect(color.clone().desaturate().toRgb()).to.deep.equal({
      r: 255,
      g: 0,
      b: 0,
      a: 1,
    ...
    expect([r, g, b].map(roundPart)).to.deep.equal([46, 56, 46]);
  });
  it("Test Color Manipulation - greyscale", () => {
    const { r, b, g } = new Color("rgb(41, 41, 61)").greyscale().toRgb();
    expect([r, g, b].map(roundPart)).to.deep.equal([51, 51, 51]);
  });
});
